        ...
        <div className="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          <div className="order-2 md:order-1">
            <div className="space-y-6">
              ...
              <p className="text-gray-300 leading-relaxed">
                Образование в ведущих медицинских институтах мира, стажировки в космических центрах и постоянное изучение новейших исследований позволяют мне предлагать лучшие решения для вашего здоровья.
              </p>
